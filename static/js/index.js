(function() {
    ...
    app.controller('customersCtrl', function($scope) {
        $scope.list = [{
            ...
            'time': '2016.4',
            'link': 'http://119.29.240.225/faceswap.py',//做个界面
            'id': 'item5'
        }, {
            'title': '隐写术',
            ...
            'time': '2016.5',
            'link': 'http://1.yinxieshu.applinzi.com/encode.php,http://1.yinxieshu.applinzi.com/decode.php',
            'id': 'item6'
        }, {
            'title': '腾讯众创海报生成器',
            'img': './static/img/jdxdxr_6.png',
            'intro': '腾讯众创开园活动的一个小玩具~(手机里打开哦^_^)',
            'func': '选择本地照片（拍照或相册）;用自己的照片瞬间做成一个高大上的封面或海报;可自己输入内容;将照片保存到本地相册;分享应用',
            'time': '2016.5',
            'link': 'http://tengxunzhongchuang.applinzi.com/txzc',
            'id': 'item7'
        }, {
            'title': '自动发送邮件工具',
            'img': './static/img/jdxdxr_7.png',
            'intro': '为了方便给几千人发送邮件而写的一个小工具~',
            'func': '一键给几千人发送邮件;可读取excel中的邮箱信息和txt中的正文内容;可由用户输入主题;可添加多个附件;可视化界面;可检测邮箱是否合法',
            'time': '2016.5',
            'link': 'http://119.29.240.225/sendemail/sendemail_test.vbs',//界面
            'id': 'item8'
        }, {
            'title': '长江云政务新媒体平台',
            'img': './static/img/jdxdxr_8.jpg',
            'intro': '实习时参与的项目~',
